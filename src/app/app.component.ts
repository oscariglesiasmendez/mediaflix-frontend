...
export class AppComponent {
  ...
  games: any[]= [
    ...
    },
    {
      ...
      "description": "Rise of the Ronin es un GAME de acción y rol en mundo abierto exclusivo de PlayStation 5 desarrollado por Team NINJA que se enfoca en el combate y en la historia épica de un samurai del Japón del siglo XIX que buscará forjar su propio nombre y que acabará decidiendo el destino del país nipón.",
      "stock": 15,
      "language": "Multiidioma",
      "productType": "GAME",
      "price": 69.9,
    ...
    {
      "title": "Tekken 8",
      "description": "Prepárate para el próximo capítulo de la legendaria franquicia del juego de lucha: TEKKEN 8.",
      "stock": 10,
      "language": "Multiidioma",
      "productType": "GAME",
      "price": 52.99,
    ...
    },
    {
      ...
      "description": "La primera entrega en 3D de la serie METAL GEAR introduce una trama de acción y sigilo con escenas de acción en vivo y cinemáticas con una innovadora mecánica de juego.",
      "stock": 5,
      "language": "Multiidioma",
      "productType": "GAME",
      "price": 40.94,
    ...
    },
    {
      ...
      "description": "Sobrevive tanto como puedas en cada partida mientras decides tu camino a través de una serie de encuentros aleatorios con diferentes enemigos y lugares inolvidables de toda la Parte II, todo ello culminando en tensas batallas contra jefes.",
      "stock": 15,
      "language": "Multiidioma",
      "productType": "GAME",
      "price": 41.99,
